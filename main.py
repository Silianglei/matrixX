...
m1 = add_edge(m1, 25 * (i + 7), 400, 0, 25 * (i + 14), 50, 0)
m1 = add_edge(m1, 25 * (i + 14), 50, 0, 25 * (i -1), 300, 0)
m1 = add_edge(m1, 25 * (i -1), 300, 0, 25 * (i + 15), 300, 0)
m1 = add_edge(m1, 25 * (i + 15), 300, 0, 25 * i, 50, 0,)
